UrlDet = UrlDet.replace("GetEProcureHistory", "");
var EProcureModel = function () {
    var self = this;
    self.EProcureHistoryArray = ko.observableArray();
        ...
        setTimeout(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    self.EProcureHistoryArray(Data1);
                    if (self.EProcureHistoryArray().length == 0) {
    ...
    self.DatatableCall = function () {
        if ($("#gvEProcureSummary > tbody > tr").length == self.EProcureHistoryArray().length) {
    ...
    self.loadEProcureSummaryGrid = function () {
        ...
        self.EProcureHistoryArray([]);
    }
    self.loadEProcureSummaryGrid();
};

var mainViewModel = new EProcureModel();
