...
UrlDet = UrlDet.replace("FetchSaleInvoiceTrackerReport", "");
...
var SearchModel = function (id) {
    ...
    this.search = function (id) {
        ...
        $.ajax({
            type: "post",
            url: UrlDet + "FetchSaleInvoiceTrackerReport",
    ...
    self.Download = function () {
        ...
        $.ajax({
            type: "post",
            url: UrlDet + "DownloadSaleInvoiceTrackerReport",
            data: ko.toJSON(InputFilter),
            async: false,
            contentType: "application/json;",
            success: function (response) {
                if (response == "process") {
                    ko.utils.postJson(UrlDet + "DownloadExcelSaleInvoiceTrackerRpt");
                } else {
                    jAlert("Sorry No Record Found!", "Message");
                }
            },
