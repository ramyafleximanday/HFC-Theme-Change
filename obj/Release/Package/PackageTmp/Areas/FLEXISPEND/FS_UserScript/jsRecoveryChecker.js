...
UrlDet = UrlDet.replace("GetRecoveryChecker", "");
...
var RecoveryCheckerModel = function () {
    ...
    self.Select = function (item) {
        ...
        if (status == 'Approved') {
            ...
            $("input[name=rdoGLType][value=" + item.Recovery_Type + "]").prop("checked", true);
...
$(document).ready(function () {
    ...
    $("#txtCheckerRemark").keypress(function () {
        checkValidationUpdate();
...
function ShowDialog() {
    ...
    objDialogy.dialog({ title: 'Recovery - Checker', width: '800', height: '450' });
