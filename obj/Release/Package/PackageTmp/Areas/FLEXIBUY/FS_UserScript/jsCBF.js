...
var SearchModel = function (id) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (Data1[0].Clear == true) {
                    ...
                    //location = '../CBF/Edit?Id=' + RefGId + '&Attachment=1'; //Bharathi 29 Oct 19 wrote // ramya commentted on 22 jun 22
                }
            },
            error: function (XMLHttpRequest, textStatus, errorThrown) {
                //alert(errorThrown);
    ...
    this.AttachmentDownLoad = function (AttachmentGId, FileName) {
        ...
        //alert(FormattedFileName);
        form.attr("action", UrlDet + "Download?Id=" + AttachmentGId + "&FileName=" + FormattedFileName);
    ...
    this.PARAttachmentDownLoad = function (FileName) {
        ...
        var form = $('#frmDeactivation');
        var FormattedFileName=FileName.replace("&","-");
        form.attr("action", UrlDet + "DownloadPARDetails?FileName=" + FormattedFileName);
        form.attr("method", "post");
        form.attr("encoding", "multipart/form-data");
        form.attr("enctype", "multipart/form-data");
        form.attr("target", "postiframe");
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.Data1 != null && response.Data1 != "" && JSON.parse(response.Data1) != null) {
                    ...
                    if ((Data1[0].Clear == true) && (Type != "7") && (Type != "8")) {
                        hideProgress();
                        jConfirm(Data1[0].Message + "Do you want continue to approve next claim", "Success", function (r) {
                            ...
                            if (r == true) {
                                ...
                                if (data2 == "0")
                                {
                                    jAlert("No approval items pending", "Success", function () {
                                            ...
                                            location = "../../../flexibuydashboard/ForMyApprovalSummaryIndex?type=CBF&" + new Date().getTime();
					...
					var dd = data2.length;
                        ...
                        jAlert(Data1[0].Message, "Message", function () {
                            location = "../../../CBFClosureChk/CbfClosureChkIndex?" + new Date().getTime();
                        });
...
$(document).ready(function () {
    ...
    $(".txtUploadSupAttachmentFile").on('change', function (e) {
        ...
        form.attr("action", UrlDet + "UploadCBFAttachment/?uploadfor=PR&attach=" + Attach_list + '&attaching_format=' + Attachment_fomat);
    ...
    $(".txtUploadDAttachment").on('change', function (e) {
        ...
        var Attach_list = Attachment_list();
        var Attachment_fomat = Attached_fileformat();
        form.attr("action", UrlDet + "UploadCBFAttachment/?attach=" + Attach_list + '&attaching_format=' + Attachment_fomat);
        //form.attr("action", UrlDet + "UploadCBFAttachment");
        form.attr("method", "post");
        form.attr("encoding", "multipart/form-data");
        form.attr("enctype", "multipart/form-data");
