...
{
    public class GSTModificationController : Controller
    {
        CmnFunctions objCmnFunctions = new CmnFunctions();
        private GSTIRepository objModel;

        public GSTModificationController()
            : this(new GSTSupDataModel())
        {

        }
        public GSTModificationController(GSTIRepository objM)
        {
            objModel = objM;
        }
        ...
        {            
          //  Session["ModificationQueueSearch"] = null;
            ...
            if (fromlink != null)
            {
                ...
                else if (fromlink.Trim() == "gstmodification")
                {
                    Session["Totalsuppliers"] = null;
                    Session["Supplierrenewalpro"] = null;
                    ViewBag.ModificationListTitle = "Supplier Queue - GST Modification";
                }
            }
