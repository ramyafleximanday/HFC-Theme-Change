...
namespace IEM.Areas.ASMS.Models
{
    public interface IRepository
    {
        ...
        List<SupplierContactDetails> GetCityByState(int StateID, int CountryID);
        ...
        string DeleteSupplierRenewal(string suppliercode = null);

        DataTable getcontracttodate();

        List<EntityGstvendor> getvendor();
        List<EntityGstvendor> GetState();
        ...
        string getUserRole(); //26-04-2017
        List<SupplierContactDetails> Getcitylist(int Pincodeid);

      
        IEnumerable<EntityGstvendor> getmaker();  
        List<SupplierContactDetails> GetAllDistrict(); //pandiaraj 10/07/2017
    }
