...
//Gopi
var objDialogyInvoiceNonTravel;
var objDialogyGSTNonTravel;
...
var SearchModel = function (id) {
    ...
    self.GSTChangeTaxType = function () {
        ...
        $("#ddlGSTTaxType,#ddlGSTSubTaxType,#txtGSTRate,#txtGSTTaxableAmount,#txtGSTTaxAmount").removeClass("valid").removeClass("required");
        $("#txtGSTRate,#txtGSTTaxableAmount").addClass("required");
    ...
    //    $("#txtGSTTaxRate").attr("disabled", true);
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (Data1[0].Clear == 2) {
                    $("#txtGSTRate").val(Data1[0].taxrate);
                   ...
                   // $("#txtGSTTaxRate").removeAttr("disabled"); pandiaraj 
    ...
    self.AddInvoiceDetails = function () {
        $('#divInvoiceNonTravel').attr("style", "display:block;");
        objDialogyInvoiceNonTravel.dialog({ title: 'Add Invoice Details', width: '1100', height: '650' });
        objDialogyInvoiceNonTravel.dialog("open");
    ...
    self.EditInvoiceDetails = function (item) {
        $('#divInvoiceNonTravel').attr("style", "display:block;");
        objDialogyInvoiceNonTravel.dialog({ title: 'Invoice Details', width: '1100', height: '650' });
        objDialogyInvoiceNonTravel.dialog("open");

        $("#hfInvId").val(item.InvId);
        $("#ddlgstReceiverLoc,#ddlgstProviderLoc,#hdfSVendorId,#hdfSVendorName").val("0");
        $("#txtInvoiceDate,#txtInvoiceNo,#txtServiceMonth,#txtInvoiceAmount,#txtWithoutTaxAmount,#txtInvoiceDescription,#txtVendorName,#txtVendorCode,#txtGSTINState,#txtGSTINpan,#txtGSTINvertical,#txtGSTINFICCL").val("");
        $("input[name=rdogstChargedFlag][value=Y]").prop("checked", true);
        $("input[name=rdoVerify][value=1]").prop("checked", true);
        $("#txtGSTINState,#txtGSTINpan,#txtGSTINvertical,#txtInvoiceDate,#txtInvoiceNo,#txtServiceMonth,#txtInvoiceAmount,#txtWithoutTaxAmount,#txtInvoiceDescription,#txtVendorName,#txtVendorCode,#ddlgstReceiverLoc,#ddlgstProviderLoc").removeClass("valid").removeClass("required");
        ...
        $.ajax({
            type: "post",
            url: UrlDet + "GetInvoiceDetailsPettyCash",
            data: JSON.stringify(EcfFilter),
            contentType: "application/json;",
            async: false,
            success: function (response) {
                var Data1 = "", Data2 = "", Data3 = "", Data4 = "", Data5 = "", value = "", Data6 = "";
                if (response.Data1 != null && response.Data1 != "" && JSON.parse(response.Data1) != null)
                    Data1 = JSON.parse(response.Data1);
                ...
                if (Data1.length > 0) {
                    ...
                    //Ramya
                    $("#txtGSTINState").val((Data1[0].GstinVendor).substring(0, 2));
                    $("#txtGSTINpan").val((Data1[0].GstinVendor).substring(2, 12));
                    $("#txtGSTINvertical").val((Data1[0].GstinVendor).substring(12, 15));
                    //Ramya
                    ...
                    value = $("#txtGSTINState").val();
                    if (value != "")
                        $("#txtGSTINState").addClass("valid");
                    else
                        $("#txtGSTINState").addClass("required");
    ...
    self.ViewInvoiceDetails = function (item) {
        $('#divInvoiceNonTravel').attr("style", "display:block;");
        objDialogyInvoiceNonTravel.dialog({ title: 'Invoice Details', width: '1100', height: '600' });
        objDialogyInvoiceNonTravel.dialog("open");
    ...
    self.SaveInvoiceDetails = function () {
        var GstCharged = "N", ProviderLocation = "0", GstinVendor = "", ReceiverLocation = "0", GstinFiccl = "", VendorId = "0";
                ...
                GstinVendor = $("#txtGSTINState").val() + $("#txtGSTINpan").val() + $("#txtGSTINvertical").val();
                    ...
                    if (Data1[0].Clear == false)
                        ...
                        $("#hfInvId").val(Data1[0].InvId);
                                ...
                                if (response.Data6 != null && response.Data6 != "" && JSON.parse(response.Data6) != null) {
                                    ...
                                    $("#lblPayMethod").text(Data7[0].PayMethod);
    ...
    self.AddGSTTax = function () {
        $('#GSTDialogNonTravel').attr("style", "display:block;");
        ...
        objDialogyGSTNonTravel.dialog({ title: 'Add GST', width: '460', height: '400' });
        objDialogyGSTNonTravel.dialog("open");
        return false;
    };
    ...
    self.ViewGSTTax = function (item) {
        ...
        objDialogyGSTNonTravel.dialog({ title: 'View GST', width: '460', height: '400' });
        objDialogyGSTNonTravel.dialog("open");
    };
    self.EditGSTTax = function (item) {
        ...
        $("#hfGSTInvoiceTaxGid").val(item.invoicetaxgid);
        //$("#ddlGSTHSNCode option:contains(" + item.HsnCode + ")").attr('selected', 'selected');
        $("#ddlGSTHSNCode option:contains(" + item.HsnCode + ")").attr('selected', 'selected');  //Ramya
        ...
        $("#btnGSTTaxSubmit").css("display", "");
        objDialogyGSTNonTravel.dialog({ title: 'GST Invoice Tax', width: '460', height: '400' });
        objDialogyGSTNonTravel.dialog("open");
    };
            ...
            success: function (response) {
                ...
                if (response.Data1 != null && response.Data1 != "" && JSON.parse(response.Data1) != null) {
                    ...
                    if (Data1[0].Clear == false)
                        ...
                        objDialogyGSTNonTravel.dialog("close");
                        jAlert(Data1[0].Msg, "Message");
                    }
                }
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.Data1 != null && response.Data1 != "" && JSON.parse(response.Data1) != null) {
                    Data1 = JSON.parse(response.Data1);
                    if (Data1[0].Clear == false) {
                        objDialogyInvoiceNonTravel.dialog("close");
    ...
    this.LoadECFDetails = function () {
        ...
        $.ajax({
            type: "post",
            url: UrlDet + "GetEmployeeNonTravelClaim",
            data: JSON.stringify(EcfFilter),
            contentType: "application/json;",
            success: function (response) {
                $("#hfInvId").val("0");
    ...
    this.SetInvoiceDebitDetails = function () {
        ...
        var ClaimFrm = $("#txtClaimFrom").val();
        var ClaimTo = $("#txtClaimTo").val();
        ...
        $.ajax({
            type: "post",
            url: UrlDet + "SetNTExpenseDetails",
    ...
    this.DeleteInvoiceDebitDetails = function (DebitlineGId) {
        ...
        jConfirm("Are you sure? Want to delete Expense!", "Confirm", function (callback) {
            if (callback == true) {
                var ECFId = $("#hfECFId").val();
                var invid = $("#hfInvId").val();
                var expnaturegid = "0";
            ...
            success: function (response) {
                ...
                if (response.Data1 != null && response.Data1 != "" && JSON.parse(response.Data1) != null) {
                    ...
                    if (Data1[0].Clear == false)
                        ...
                        } else { objDialogyAddPayment.dialog("close"); }
    ...
    this.EditInvoiceDebitDetails = function (Index, flag) {
       ...
       // alert(_tmpData.ecftravel_hsn_gid);
        //$("#ddlhsngid option:contains(" + _tmpData.ecftravel_hsn_gid + ")").attr('selected', 'selected');
        ...
        objDialogyAddDebit.dialog({ title: 'Expense Details', width: '800', height: '450' });
...
//kavitha
    ...
    self.ECFExpenseHistory = ko.observableArray();
...
var DebitlineGId = $("#hfDebitlineGId").val();
    ...
    objDialogyInvoiceNonTravel = $("[id$='divInvoiceNonTravel']");
    objDialogyInvoiceNonTravel.dialog({
        autoOpen: false,
        modal: true,
        width: 1100,
        height: 600,
    ...
    //Gopi
    objDialogyGSTNonTravel = $("[id$='GSTDialogNonTravel']");
    objDialogyGSTNonTravel.dialog({
        autoOpen: false,
        modal: true,
        width: 460,
        height: 290,
 ...
 //Pandiaraj 07-05-2018 focus out 
    ...
    $("#drpaudit").change(function () {
        ...
        if ($('#drpaudit').val() == 1) {
            ...
            $("#ExpenseHistory").css("display", "none");
            ...
            $("#InvoiceHeader").css("display", "none");
            $("#GstTaxHeader").css("display", "none");
            $("#ExpenseHistory").css("display", "block");
            $("#showpaymentdialog").css("display", "none");
        }
...
function AddDebitAmount() {
    ...
    var value = $("#hfInvId").val();
    if (value == null || value == "0" || value == "") {
        jAlert("Please Add Invoice Header Details.", "Message");
        return false;
    }
...
//Cygnet details
self.GetCygnetInvoiceDetails = function (item) {
    debugger;

    $('#divCygnet').attr("style", "display:block;");

    objdialogCygnet.dialog({
        title: 'Invoice GSTN Details', width: '1100', height: '600', close: function (event, ui) {
            objdialogCygnet.dialog('destroy');
        }
    });
    objdialogCygnet.dialog("open");
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (Data1.length > 0) {
                ...
                $("#hdfSVendorName").val(Data1[0].Cygnet_Supplier_Gid);
                $("#txtInvoiceDate").val(Data1[0].InvDate);
                $("#txtInvoiceNo").val(Data1[0].InvNo);
                ...
                $("#txtGSTINvertical").val(Data1[0].GstinVendor.substring(12));
                $("#txtGSTINFICCL").val(Data1[0].GstinFiccl);
