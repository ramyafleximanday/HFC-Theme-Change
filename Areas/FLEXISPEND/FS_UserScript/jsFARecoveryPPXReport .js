var objDialogyAdd;
UrlDet = UrlDet.replace("RecoveryPPXReport", "");
...
var SearchModel = function (id) {
    ...
    self.search = function (id) {
        ...
        $.ajax({
            type: "post",
            url: UrlDet + "FetchRecoveryPPXReport",
    ...
    self.Download = function () {
        ...
        $.ajax({
            type: "post",
            url: UrlDet + "DownloadRecoveryPPXReport",
            data: ko.toJSON(InputFilter),
            async: false,
            contentType: "application/json;",
            success: function (response) {
                if (response == "process") {
                    hideProgress();
                    ko.utils.postJson("../FAReport/DownloadExcelRecoveryPPXRpt");
                } else {
                    hideProgress();
                    jAlert("Sorry No Record Found!", "Message");
                }
