var objDialogyAdd;
UrlDet = UrlDet.replace("RecoveryReport", "");
...
var SearchModel = function (id) {
    ...
    self.search = function (id) {
        ...
        $.ajax({
            type: "post",
            url: UrlDet + "FetchRecoveryReport",
    ...
    self.Download = function () {
        ...
        $.ajax({
            type: "post",
            url: UrlDet + "DownloadRecoveryReport",
            data: ko.toJSON(InputFilter),
            async: false,
            contentType: "application/json;",
            success: function (response) {
                if (response == "process") {
                    hideProgress();
                    ko.utils.postJson("../FAReport/DownloadExcelRecoveryRpt");
                } else {
                    hideProgress();
                    jAlert("Sorry No Record Found!", "Message");
                }
